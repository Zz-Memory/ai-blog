...
export function BloggerCenterComments({ reviewItems, reviewFilter, onFilterChange, visibleReviews, reviewPage, totalReviewPages, onPrevPage, onNextPage, onPageChange, activeMenuTitle, activeMenuPosition, onMenuOpen, onMenuClose, reviewStatusMeta, reviewActionMap }: Props) {
  return (
