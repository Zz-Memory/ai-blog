...
export function BloggerCenterMessages({ messages, activeTab, onTabChange, specificAudience, onSpecificAudienceChange, scheduledSend, onScheduledSendChange, activeMenuTitle, activeMenuPosition, onMenuOpen, onMenuClose }: Props) {
  return (
